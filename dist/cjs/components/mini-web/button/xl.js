...
const ButtonXL = (props) => {
    ...
    const style = useStyle
        ...
        : {};
    return (react_1.default.createElement("button", Object.assign({ className: `moki-ui-dev dev-btn dev-btn-48 text-500-16 dev-border-8  ${className}`, onMouseEnter: () => setFocus(true), onMouseLeave: () => setFocus(false), style: style, type: type, title: title, onClick: onClick, disabled: disabled }, rest), children));
};
exports.default = ButtonXL;
